...
var _getBrowserRtc = require('./util/get-browser-rtc.js');

var _getBrowserRtc2 = babelHelpers.interopRequireDefault(_getBrowserRtc);

var _ipvx = require('./util/ipvx.js');

var _ipvx2 = babelHelpers.interopRequireDefault(_ipvx);
...
var Peer = function (_EventEmitter) {
  ...
  function Peer(opts) {
    ...
    _this._id = (0, _uuid2.default)().substr(0, 8);
    ...
    _this.channelName = _this.opts.initiator ? _this.opts.channelName || (0, _uuid2.default)() : null;
    ...
    _this._wrtc = _this.opts.wrtc && babelHelpers.typeof(_this.opts.wrtc) === 'object' ? _this.opts.wrtc : (0, _getBrowserRtc2.default)();
  ...
  babelHelpers.createClass(Peer, [{
    ...
    */
    ...
    get: function get() {
      return {
        port: this.localPort,
        family: (0, _ipvx2.default)(this.localAddress),
    ...
    key: 'WEBRTC_SUPPORT',
    get: function get() {
      return !!(0, _getBrowserRtc2.default)();
    }
